...
| 2025-11-17T15:22:01-06:00 | Codex  | Replaced stubbed Equidna packages with official releases: adopted ResponseHelper outputs, ForceJson middleware, Sanctum Bearer tokens, SwiftAuth role model extensions, new roles/pivot migrations, updated seeds/tests, and refreshed README. | Verify sqlite driver before re-running PHPUnit locally. |
